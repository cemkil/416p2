...
public class SSLServerThread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            os.write(kuID.charAt(counter));
            os.flush();
            System.out.println("Client " + sslSocket.getRemoteSocketAddress() + " sent : " + counter);
